  ...
  this._consumer(consumerKey, function(err, consumer, consumerSecret) {
    ...
    function verified(err, user, tokenSecret, info) {
      ...
      if (signatureMethod == 'HMAC-SHA1') {
        ...
        // Check that with the public key we can verify this signature.
        // consumerSecret should be the public key.
        var verifier = crypto.createVerify("RSA-SHA1").update(base);
        var valid = verifier.verify(consumerSecret, signature, 'base64');
